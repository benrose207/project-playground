...
const SlideInOnScroll = () => {
  ...
  return (
    <div className="content-container article-wrap">
      ...
      <img src="http://unsplash.it/400/400" className="align-left slide-img-in" alt="random img 1"/>
      ...
      <img src="http://unsplash.it/400/401" className="align-right slide-img-in" alt="random img 2"/>
      ...
      <img src="http://unsplash.it/200/500" className="align-left slide-img-in" alt="random img 3"/>

      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio maiores adipisci quibusdam repudiandae dolor vero placeat esse sit! Quibusdam saepe aperiam explicabo placeat optio, consequuntur nihil voluptatibus expedita quia vero perferendis, deserunt et incidunt eveniet <img src="http://unsplash.it/200/200" className="align-right slide-img-in" alt="random img 4"/> temporibus doloremque possimus facilis. Possimus labore, officia dolore! Eaque ratione saepe, alias harum laboriosam deserunt laudantium blanditiis eum explicabo placeat reiciendis labore iste sint. Consectetur expedita dignissimos, non quos distinctio, eos rerum facilis eligendi. Asperiores laudantium, rerum ratione consequatur, culpa consectetur possimus atque ab tempore illum non dolor nesciunt. Neque, rerum. A vel non incidunt, quod doloremque dignissimos necessitatibus aliquid laboriosam architecto at cupiditate commodi expedita in, quae blanditiis. Deserunt labore sequi, repellat laboriosam est, doloremque culpa reiciendis tempore excepturi. Enim nostrum fugit itaque vel corporis ullam sed tenetur ipsa qui rem quam error sint, libero. Laboriosam rem, ratione. Autem blanditiis</p>
      ...
      <img src="http://unsplash.it/400/400" className="align-right slide-img-in" alt="random img 5"/>
